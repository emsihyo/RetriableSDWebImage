...
- (void)sd_setHighlightedImageWithURL:(NSURL *)url
    ...
    [self sd_internalSetImageWithURL:url placeholderImage:nil options:options operationKey:@"UIImageViewImageOperationHighlighted" setImageBlock:^(UIImage * image, NSData * imageData,SDImageCacheType cacheType,NSURL *imageURL) {
